...
type PluginSpecificConfig struct {
	...
	//	*PluginSpecificConfig_DotnetPaket
...
func (x *PluginSpecificConfig) GetDotnetPaket() *DotnetPaketConfig {
	if x != nil {
		if x, ok := x.Config.(*PluginSpecificConfig_DotnetPaket); ok {
			return x.DotnetPaket
		}
	}
	return nil
}
...
func (x *PluginSpecificConfig) GetPythonRequirementsTransitive() *PythonRequirementsTransitiveConfig {
	if x != nil {
		if x, ok := x.Config.(*PluginSpecificConfig_PythonRequirementsTransitive); ok {
...
func (x *PluginSpecificConfig) GetSpack() *SpackConfig {
	if x != nil {
		if x, ok := x.Config.(*PluginSpecificConfig_Spack); ok {
			return x.Spack
		}
	}
	return nil
...
func (x *PluginSpecificConfig) GetCsproj() *CsProjConfig {
	if x != nil {
		if x, ok := x.Config.(*PluginSpecificConfig_Csproj); ok {
			return x.Csproj
		}
	}
	return nil
...
func (x *PluginSpecificConfig) GetNugetCpm() *NugetCPMConfig {
	if x != nil {
		if x, ok := x.Config.(*PluginSpecificConfig_NugetCpm); ok {
			return x.NugetCpm
		}
	}
	return nil
...
func (x *PluginSpecificConfig) GetOsvdev() *OSVDevConfig {
	if x != nil {
		if x, ok := x.Config.(*PluginSpecificConfig_Osvdev); ok {
			return x.Osvdev
		}
	}
	return nil
...
func (x *PluginSpecificConfig) GetHcpIdentity() *HCPIdentityConfig {
	if x != nil {
		if x, ok := x.Config.(*PluginSpecificConfig_HcpIdentity); ok {
...
func (x *PluginSpecificConfig) GetHerokuExpiration() *HerokuExpirationConfig {
	if x != nil {
		if x, ok := x.Config.(*PluginSpecificConfig_HerokuExpiration); ok {
...
func (x *PluginSpecificConfig) GetHuggingfaceMeta() *HuggingfaceMetaConfig {
	if x != nil {
		if x, ok := x.Config.(*PluginSpecificConfig_HuggingfaceMeta); ok {
...
type PluginSpecificConfig_DotnetPaket struct {
	DotnetPaket *DotnetPaketConfig `protobuf:"bytes,76,opt,name=dotnet_paket,json=dotnetPaket,proto3,oneof"`
}
...
func (*PluginSpecificConfig_DotnetPaket) isPluginSpecificConfig_Config() {}
...
func (x *DotnetPaketConfig) Reset() {
	*x = DotnetPaketConfig{}
...
func (x *DotnetPaketConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DotnetPaketConfig) ProtoMessage() {}

func (x *DotnetPaketConfig) ProtoReflect() protoreflect.Message {
	mi := &file_proto_config_proto_msgTypes[42]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DotnetPaketConfig.ProtoReflect.Descriptor instead.
func (*DotnetPaketConfig) Descriptor() ([]byte, []int) {
	return file_proto_config_proto_rawDescGZIP(), []int{42}
}

func (x *DotnetPaketConfig) GetMaxFileSizeBytes() int64 {
	if x != nil {
		return x.MaxFileSizeBytes
	}
	return 0
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xb8\x1f\n" +
	...
	"\amariadb\x18/ \x01(\v2\x16.scalibr.MariadbConfigH\x00R\amariadb\x12?\n" +
	"\fdotnet_paket\x18L \x01(\v2\x1a.scalibr.DotnetPaketConfigH\x00R\vdotnetPaket\x125\n" +
	...
	"\x1epython_requirements_transitive\x18D \x01(\v2+.scalibr.PythonRequirementsTransitiveConfigH\x00R\x1cpythonRequirementsTransitive\x12,\n" +
	"\x05spack\x18E \x01(\v2\x14.scalibr.SpackConfigH\x00R\x05spack\x12/\n" +
	"\x06csproj\x18F \x01(\v2\x15.scalibr.CsProjConfigH\x00R\x06csproj\x126\n" +
	"\tnuget_cpm\x18G \x01(\v2\x17.scalibr.NugetCPMConfigH\x00R\bnugetCpm\x12/\n" +
	...
	"\x15deps_dev_requirements\x18\x02 \x01(\bR\x13depsDevRequirements\"\x85\x01\n" +
	...
	"\fCsProjConfig\x12-\n" +
	"\x13max_file_size_bytes\x18\x01 \x01(\x03R\x10maxFileSizeBytes\"?\n" +
	"\x0eNugetCPMConfig\x12-\n" +
	"\x13max_file_size_bytes\x18\x01 \x01(\x03R\x10maxFileSizeBytes\"2\n" +
	"\x15HuggingfaceMetaConfig\x12\x19\n" +
	"\bbase_url\x18\x01 \x01(\tR\abaseUrl\"3\n" +
	"\x16HerokuExpirationConfig\x12\x19\n" +
	"\bbase_url\x18\x01 \x01(\tR\abaseUrl\".\n" +
	"\x11HCPIdentityConfig\x12\x19\n" +
	"\bbase_url\x18\x01 \x01(\tR\abaseUrl\"K\n" +
...
var file_proto_config_proto_goTypes = []any{
	...
	(*DotnetPaketConfig)(nil),                  // 42: scalibr.DotnetPaketConfig
	(*GemspecConfig)(nil),                      // 43: scalibr.GemspecConfig
	(*CargoAuditableConfig)(nil),               // 44: scalibr.CargoAuditableConfig
	(*SwiftPackageResolvedConfig)(nil),         // 45: scalibr.SwiftPackageResolvedConfig
	(*SwiftPodfileLockConfig)(nil),             // 46: scalibr.SwiftPodfileLockConfig
	(*ElixirMixLockConfig)(nil),                // 47: scalibr.ElixirMixLockConfig
	(*HaskellStacklockConfig)(nil),             // 48: scalibr.HaskellStacklockConfig
	(*HaskellCabalConfig)(nil),                 // 49: scalibr.HaskellCabalConfig
	(*JavaArchiveConfig)(nil),                  // 50: scalibr.JavaArchiveConfig
	(*JavascriptPackageJsonConfig)(nil),        // 51: scalibr.JavascriptPackageJsonConfig
	(*JavascriptPackageLockJsonConfig)(nil),    // 52: scalibr.JavascriptPackageLockJsonConfig
	(*PythonRequirementsConfig)(nil),           // 53: scalibr.PythonRequirementsConfig
	(*PythonSetupConfig)(nil),                  // 54: scalibr.PythonSetupConfig
	(*PythonCondametaConfig)(nil),              // 55: scalibr.PythonCondametaConfig
	(*PythonWheelEggConfig)(nil),               // 56: scalibr.PythonWheelEggConfig
	(*GoModConfig)(nil),                        // 57: scalibr.GoModConfig
	(*WordpressPluginsConfig)(nil),             // 58: scalibr.WordpressPluginsConfig
	(*MariadbConfig)(nil),                      // 59: scalibr.MariadbConfig
	(*OSVLocalConfig)(nil),                     // 60: scalibr.OSVLocalConfig
	(*OSVDevConfig)(nil),                       // 61: scalibr.OSVDevConfig
	(*CodeServerConfig)(nil),                   // 62: scalibr.CodeServerConfig
	(*QCOW2Config)(nil),                        // 63: scalibr.QCOW2Config
}
var file_proto_config_proto_depIdxs = []int32{
	...
	43, // 31: scalibr.PluginSpecificConfig.gemspec:type_name -> scalibr.GemspecConfig
	44, // 32: scalibr.PluginSpecificConfig.cargo_auditable:type_name -> scalibr.CargoAuditableConfig
	45, // 33: scalibr.PluginSpecificConfig.swift_package_resolved:type_name -> scalibr.SwiftPackageResolvedConfig
	46, // 34: scalibr.PluginSpecificConfig.swift_podfile_lock:type_name -> scalibr.SwiftPodfileLockConfig
	47, // 35: scalibr.PluginSpecificConfig.elixir_mix_lock:type_name -> scalibr.ElixirMixLockConfig
	48, // 36: scalibr.PluginSpecificConfig.haskell_stacklock:type_name -> scalibr.HaskellStacklockConfig
	49, // 37: scalibr.PluginSpecificConfig.haskell_cabal:type_name -> scalibr.HaskellCabalConfig
	50, // 38: scalibr.PluginSpecificConfig.java_archive:type_name -> scalibr.JavaArchiveConfig
	51, // 39: scalibr.PluginSpecificConfig.javascript_package_json:type_name -> scalibr.JavascriptPackageJsonConfig
	52, // 40: scalibr.PluginSpecificConfig.javascript_package_lock_json:type_name -> scalibr.JavascriptPackageLockJsonConfig
	53, // 41: scalibr.PluginSpecificConfig.python_requirements:type_name -> scalibr.PythonRequirementsConfig
	54, // 42: scalibr.PluginSpecificConfig.python_setup:type_name -> scalibr.PythonSetupConfig
	55, // 43: scalibr.PluginSpecificConfig.python_condameta:type_name -> scalibr.PythonCondametaConfig
	56, // 44: scalibr.PluginSpecificConfig.python_wheel_egg:type_name -> scalibr.PythonWheelEggConfig
	57, // 45: scalibr.PluginSpecificConfig.go_mod:type_name -> scalibr.GoModConfig
	58, // 46: scalibr.PluginSpecificConfig.wordpress_plugins:type_name -> scalibr.WordpressPluginsConfig
	59, // 47: scalibr.PluginSpecificConfig.mariadb:type_name -> scalibr.MariadbConfig
	42, // 48: scalibr.PluginSpecificConfig.dotnet_paket:type_name -> scalibr.DotnetPaketConfig
	60, // 49: scalibr.PluginSpecificConfig.osvlocal:type_name -> scalibr.OSVLocalConfig
	62, // 50: scalibr.PluginSpecificConfig.code_server:type_name -> scalibr.CodeServerConfig
	5,  // 51: scalibr.PluginSpecificConfig.denojson:type_name -> scalibr.DenoJsonConfig
	6,  // 52: scalibr.PluginSpecificConfig.denotssource:type_name -> scalibr.DenoTSSourceConfig
	63, // 53: scalibr.PluginSpecificConfig.qcow2:type_name -> scalibr.QCOW2Config
	11, // 54: scalibr.PluginSpecificConfig.cpan:type_name -> scalibr.PerlCPANConfig
	15, // 55: scalibr.PluginSpecificConfig.python_requirements_transitive:type_name -> scalibr.PythonRequirementsTransitiveConfig
	26, // 56: scalibr.PluginSpecificConfig.spack:type_name -> scalibr.SpackConfig
	34, // 57: scalibr.PluginSpecificConfig.csproj:type_name -> scalibr.CsProjConfig
	35, // 58: scalibr.PluginSpecificConfig.nuget_cpm:type_name -> scalibr.NugetCPMConfig
	61, // 59: scalibr.PluginSpecificConfig.osvdev:type_name -> scalibr.OSVDevConfig
	38, // 60: scalibr.PluginSpecificConfig.hcp_identity:type_name -> scalibr.HCPIdentityConfig
	37, // 61: scalibr.PluginSpecificConfig.heroku_expiration:type_name -> scalibr.HerokuExpirationConfig
	36, // 62: scalibr.PluginSpecificConfig.huggingface_meta:type_name -> scalibr.HuggingfaceMetaConfig
...
func file_proto_config_proto_init() {
	...
	file_proto_config_proto_msgTypes[1].OneofWrappers = []any{
		...
		(*PluginSpecificConfig_DotnetPaket)(nil),
	...
	file_proto_config_proto_msgTypes[59].OneofWrappers = []any{}
	type x struct{}
